<template>
  <div>
    ...
    <span
      ...
      quisquam voluptas veniam perspiciatis magni assumenda. Voluptas,
      consequatur quaerat eaque minima voluptates, ipsa tempore accusantium
      soluta est beatae atque deserunt ab?</span
    >
    <hr>
    <p>
